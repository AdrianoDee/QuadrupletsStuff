...
class PixelQuadrupletGenerator : public HitQuadrupletGeneratorFromTripletAndLayers {
    ...
    typedef CombinedHitQuadrupletGenerator::LayerTreeCacheType          LayerTreeCacheType;
    typedef CombinedHitQuadrupletGenerator::LayerDoubletsCacheType      LayerDoubletsCacheType;
